...
const api: TruthNewsApi = {
  ...
  getBibleChapter: (bookCode, chapter) => ipcRenderer.invoke('truth:get-bible-chapter', bookCode, chapter),
  searchBible: (query) => ipcRenderer.invoke('truth:search-bible', query),
